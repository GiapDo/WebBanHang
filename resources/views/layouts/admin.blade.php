                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="{{asset('images/logo/logo.webp')}}" width="30px" height="30px"
                                data-light="{{asset('images/logo/logo.webp')}}" data-dark="{{asset('images/logo/logo.webp')}}">
                        </a>
                ...
                <div class="section-content-right">
                            ...
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" 
                                        ...
                                        data-light="{{ asset('images/logo/logo.webp') }}" 
                                        data-dark="{{ asset('images/logo/logo.webp') }}" 
                                        data-retina="{{ asset('images/logo/logo.webp') }}" 
                                        width="30" 
                                        height="30">
                                </a>
                                <div class="button-show-hide">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Phương và Phúc © 2025</div>
                        </div>
                    </div>
